		...
		<div class="header">
			...
			<div class="banner">
				...
				<div class="menu">
					...
					<div class="div2">
					<ul id="navmenu">
						<li><a href="#"><?php session_start(); echo $_SESSION["first"];echo " ";echo $_SESSION["last"]; echo "||Member";?></a>
		...
		<div class="content">
			<div class="first">
				...
				<div class="notification">
					<div class="head"><h2 align="center">Notification</h2></div>
			...
			<div class="middle">
				...
				<br>
					...
					<div class="box">
							...
							<a href="donate.php">
							<div class="part">
							<div class="part1" id="mg-image" style="background-image: url(images/donate.jpg)"></div>
								<div class="part2"><h2 align="center">Donate Blood</h2></div>
								
							</div>
							</a>
							<a href="">
							<div class="part">
								<div class="part1" id="mg-image" style="background-image: url(images/donor.jpg)"></div>
								<div class="part2"><h2 align="center">Blood Bank Address</h2></div>
							</div>
							</a>
							<a href="contactus.php">
							<div class="part">
								<div class="part1" id="mg-image" style="background-image: url(images/contact.png)"></div>
								<div class="part2"><h2 align="center">Contact Us</h2></div>
							</div>
							</a>
					</div>
			...
			<div class="third">
				...
				<h3 align="center">
					<?php 
						 ...
						 echo $_SESSION["last"];echo "<br>"; 
						 $id=$_SESSION['id'];
						 $query=mysql_query("SELECT * from member where id=$id ");
						$res=mysql_fetch_array($query);
						echo "Blood Group:".$res['bloodgroup'];echo "<br>";
