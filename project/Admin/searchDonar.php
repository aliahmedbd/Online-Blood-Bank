...
<body>
		...
		<div class="search">
			...
			<div class="donar">
				<div class="title"><h2 align="center">Search All</h2></div>
				<div class="task" >
					...
					<input class="btn btn-primary btn-large btn-block" type="submit" name="submit2" value="Search All">
				...
				<table cellspacing='0' align="center"> 
    				...
    				<?php
    					...
    					if(isset($_POST['submit3'])){
    						$index=$_POST['mid'];
    						$query=mysql_query("SELECT * from member where id=$index") or die("There is no member in this ID");
    						$result=$query;
    					...
    					elseif (isset($_POST['submit1'])) {
    						...
    						$query=mysql_query("SELECT * from member where bloodgroup like '%$index%'") or die("Can not Found!!");
    						$result=$query;
    						if($index != ""){
    						while($final = mysql_fetch_array($result)){
    							echo "<tr>";
    					...
    					elseif (isset($_POST['submit2'])) {
    						...
    						$query=mysql_query("SELECT * FROM `member`") or die("Can not Found!!");
    						$result=$query;
    						while($final = mysql_fetch_array($result)){
    							echo "<tr>";
    							echo "<td>".$final['id']."</td>";
